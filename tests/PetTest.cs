...
public static IEnumerable<TestCaseData> getTestData()
    {
        String caminhoMassa = @"C:\Iterasys\PetStore139\fixtures\pet.csv";
    ...
    {
        // Configura
        int petId = 3146840;            // campo de pesquisa
        String petName = "Baruck";      // resultado esperado
    ...
    public void PutPetTest()
    {
        ...
        // Vamos criar uma classe de modelo
        PetModel petModel = new PetModel();
        petModel.id = 3146840;
        petModel.category = new Category(1, "dog");
        petModel.name = "Baruck";
